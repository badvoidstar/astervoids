...
This is a classic Asteroids game with:
- **Frontend**: Single HTML5 Canvas game (`AsteroidsWeb/wwwroot/index.html` - ~70KB, contains all game logic inline)
- **Backend**: Minimal ASP.NET Core server serving static files (`AsteroidsWeb/Program.cs`)
