...
- **Casting:** Always "Fact Checker"; an always-on built-in.
...
An Asteroids-like HTML5 website with single-player and multiplayer modes. Its backend and frontend-facing transport interfaces are intentionally game-agnostic, and its game utility layer remains reusable.
